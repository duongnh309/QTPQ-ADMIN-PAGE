...
UpdateDiscountForm.propTypes = {
    onSubmit: PropTypes.func,
};

function UpdateDiscountForm({ onSubmit, updateDiscount }) {
    ...
    const form = useForm({
        defaultValues: {
            saleOff: updateDiscount ? updateDiscount.saleOff : 50,
            startDate: today,
            endDate: defaultDate
        },
        ...
        <div>
            ...
            <form onSubmit={form.handleSubmit(handleSubmit)} className="flex flex-col ">
                ...
                <button className="btn btn-primary" type='submit' >
                    <i className="fa fa-edit"></i> Update discount
                </button>
            </form>
        </div>
    );
